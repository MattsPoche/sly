...
static char *core_form_names[CORE_FORM_COUNT] = {
	...
	[cf_record_ref] = "record-ref",
	[cf_record_set] = "record-set!",
	[cf_record_meta_ref] = "record-meta-ref",
	[cf_record_meta_set] = "record-meta-set!",
	[cf_string_p] = "string?",
	[cf_string] = "string",
	[cf_make_string] = "make-string",
	[cf_string_copy] = "string-copy",
	[cf_vector_p] = "vector?",
	[cf_eq] = "eq?",
	[cf_num_eq] = "=",
	[cf_less] = "<",
