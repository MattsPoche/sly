...
#define GET_WORKING_PTR(value) \
	((void *)((u32)GET_INTEGRAL(value) + heap_working->buf))
#define GET_FREE_PTR(value) \
	((void *)((u32)GET_INTEGRAL(value) + heap_free->buf))
#define GET_PTR(value) GET_WORKING_PTR(value)
